document.addEventListener('DOMContentLoaded', function () {
    ...
    function renderImages(images) {
        ...
        images.forEach(image => {
            ...
            downloadIcon.addEventListener('click', () => abrirVistaPrevia(image.imageUrl));
...
function renderImages(images) {
    ...
    images.forEach(image => {
        ...
        const img = document.createElement('img');img.src = image.imageUrl;const description = document.createElement('div');
...
function buscarImagenes(query) {
    ...
    const resultados = imagesWithDescription.filter(image =>image.description.toLowerCase().includes(query.toLowerCase()));
...
document.getElementById("crear-button").addEventListener("click", function() {
    ...
    } else {galeria.style.display = "block";document.getElementById("crear-form").style.display = "none"; // Ocultar el segundo código HTML
...
downloadIcons.forEach(icon => {
    ...
    icon.addEventListener('click', () => {// Obtener la imagen asociada al ícono de descargaconst image = icon.previousElementSibling;
